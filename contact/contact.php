...
<?php
    ...
    $to = 'saccaro@gmail.com'; // Replace xxxx@xxxx.com with your email address (mandatory!) 
    $subject = 'HMessage from website'; // Choose a custom subject (not mandatory)
    ...
    $from = "From: Rogerio's website"; // Replace "Beetle Template" with your site name (not mandatory)   
    $headers = "From:" . $from . "\r\n";
